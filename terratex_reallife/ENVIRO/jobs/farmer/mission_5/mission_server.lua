...
function finish_farmer_mission_5_func()
    outputChatBox("Danke, dass du das Feld geerntet hast!", client, 0, 255, 0)
    vioSetElementData(source, "isFarmingActiv", false)
    farmer_mission_cancel(client)
    destroyElement(getPedOccupiedVehicle(client))
    setElementPosition(client, -1058.248046875, -1195.4794921875, 129.17562866211)
    setTimer(setElementPosition, 2000, 1, client, -1058.248046875, -1195.4794921875, 129.17562866211)
end

...
addEventHandler( "onClientResourceStart", resourceRoot,
	function()
        ...
        blurHShader,tecName = dxCreateShader( "ADDONS/shaderbloom/blurH.fx" )
		--outputDebugString( "blurHShader is using technique " .. tostring(tecName) )

        blurVShader,tecName = dxCreateShader( "ADDONS/shaderbloom/blurV.fx" )
		--outputDebugString( "blurVShader is using technique " .. tostring(tecName) )

        brightPassShader,tecName = dxCreateShader( "ADDONS/shaderbloom/brightPass.fx" )
		--outputDebugString( "brightPassShader is using technique " .. tostring(tecName) )

        addBlendShader,tecName = dxCreateShader( "ADDONS/shaderbloom/addBlend.fx" )

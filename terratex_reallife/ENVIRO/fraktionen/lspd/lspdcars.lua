...
function createpoliceVehicles()
    ...
    table.insert(policeVehicles, vehicle)
    table.insert(frakselfcars[9], vehicle)
    vehicle = createVehicle(599, 2256.1000976563, 2430.5, 3.4621651172638, 11, 0, 0, "SAPD")
    table.insert(policeVehicles, vehicle)
    table.insert(frakselfcars[9], vehicle)
    vehicle = createVehicle(599, 2260.5, 2431.44921875, 3.4613847732544, 11, 0, 0, "SAPD")
    table.insert(policeVehicles, vehicle)
    table.insert(frakselfcars[9], vehicle)
    -- Towtruck --

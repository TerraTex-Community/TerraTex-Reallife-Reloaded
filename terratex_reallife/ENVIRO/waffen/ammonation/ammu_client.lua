...
function createAmmoGui()
    ...
    guiGridListSetItemText(AmmuGridList, row, colums[3], "5500$", false, false)
    guiGridListSetItemText(AmmuGridList, row, colums[4], "30$", false, false)
    ...
    guiGridListSetItemText(AmmuGridList, row, colums[3], "10000", false, false)
    ...
    guiGridListSetItemText(AmmuGridList, row, colums[3], "7500", false, false)
    guiGridListSetItemText(AmmuGridList, row, colums[4], "25", false, false)
    ...
    guiGridListSetItemText(AmmuGridList, row, colums[3], "11000", false, false)
    guiGridListSetItemText(AmmuGridList, row, colums[4], "30$", false, false)
    ...
    guiGridListSetItemText(AmmuGridList, row, colums[3], "45000", false, false)
    ...
    guiGridListSetItemText(AmmuGridList, row, colums[3], "75000", false, false)
    guiGridListSetItemText(AmmuGridList, row, colums[4], "250$", false, false)
    ...
    guiGridListSetItemText(AmmuGridList, row, colums[3], "150000$", false, false)
    guiGridListSetItemText(AmmuGridList, row, colums[4], "750$", false, false)
...
function onClientMarkerHit(thePlayer)
...
function clickAmmoBot(_, _, _, _, _, _, _, clickedWorld)

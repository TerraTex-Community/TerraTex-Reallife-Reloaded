...
local removeList = {
						...
						"trunk3", "*bark*", "gen_log", "trunk5","bobo_*","prolaps*","homies_*","diderSachs*","eris_*","hardon_*","cokopops_*","semi?Dirty","bobobillboard1"
					}
...
function ShaderInfoList.getShaderInfoForStrength(strength)
	...
	-- Create a new shader
	local shader = dxCreateShader2 ( "ADDONS/sunshine/roadshine3.fx", 0, maxEffectDistance )
	if not shader then
...
function dxCreateShader2( filepath, priority, maxDistance, bDebug )

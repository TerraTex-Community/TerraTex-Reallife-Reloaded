...
local changing_wind_direction = true
...
addEventHandler("onClientResourceStart",getResourceRootElement(getThisResource()),function()
	...
	snow.window = guiCreateWindow(290,345,285,340,"Snow Settings",false)
	snow.cursor_highlight_checkbox = guiCreateCheckBox(170,18,106,19,"Highlight cursor",true,false,snow.window)
	
	snow.wind_direction_image = guiCreateStaticImage(20,144,64,64,"ADDONS/winter/snowfall/direction_image.png",false,snow.window)
	snow.wind_direction_pointer = guiCreateStaticImage(20,144,16,16,"ADDONS/winter/snowfall/direction_pointer.png",false,snow.window)
	snow.wind_direction_pointer_middle = guiCreateStaticImage(44,168,16,16,"ADDONS/winter/snowfall/direction_pointer.png",false,snow.window)
...
function highlightCursor()
	...
	if highlight then
		...
		if x and y then
			dxDrawImage ( sx*x - 2, sy*y - 1, 15, 15,  "ADDONS/winter/snowfall/cursor.png", 0,0,0,tocolor(255,0,0,255),true )
		end
	end
end

...
local function handlerCreateMedicVehicle()
	...
	table.insert(frakselfcars[10], vehicle)
	vehicle = createVehicle(416, 1615, 1850.6999511719, 10.949999809265, 0, 0, 180, "EMERGENCY")
	table.insert(frakselfcars[10], vehicle)
	vehicle = createVehicle(416, 1619.1999511719, 1850.6999511719, 10.949999809265, 0, 0, 180, "EMERGENCY")
	table.insert(frakselfcars[10], vehicle)
	-- Police LV --
	vehicle = createVehicle(598, 1594.6999511719, 1839.0999755859, 10.564999580383, 0, 0, 0, "EMERGENCY")
	table.insert(frakselfcars[10], vehicle)
	vehicle = createVehicle(598, 1599, 1839.0999755859, 10.564999580383, 0, 0, 0, "EMERGENCY")
	table.insert(frakselfcars[10], vehicle)
	-- FBI Rancher --
	vehicle = createVehicle(490, 1603.1999511719, 1838.6999511719, 10.965000152588, 0, 0, 0, "EMERGENCY")
	table.insert(frakselfcars[10], vehicle)
	vehicle = createVehicle(490, 1607.5, 1838.6999511719, 10.965000152588, 0, 0, 0, "EMERGENCY")
	table.insert(frakselfcars[10], vehicle)
	-- Sultan --
	vehicle = createVehicle(490, 1611.6999511719, 1838.9000244141, 10.515000343323, 0, 0, 0, "EMERGENCY")
	table.insert(frakselfcars[10], vehicle)
	vehicle = createVehicle(490, 1615.9000244141, 1838.9000244141, 10.515000343323, 0, 0, 0, "EMERGENCY")
	table.insert(frakselfcars[10], vehicle)
	-- Coach (Event) --

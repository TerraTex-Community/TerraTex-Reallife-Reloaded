...
SuperShopWaren={2.99,24.89,589.75,15,1.95,4.85,9.99,49.75,53.45,485.75,10000,10000,2.50,2.50,85.29}
...
function loadSuperShop_func(hitElement)
	for theKey,theTable in next, supershopMarkers do
...
function closeSuperShopGUI()
	...
	setElementPosition(source,supershopMarkers[id].x,supershopMarkers[id].y,supershopMarkers[id].z)
end

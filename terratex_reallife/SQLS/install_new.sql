...
--
-- Host: localhost
-- Erstellungszeit: 02. Sep 2017 um 20:35
...
--
-- Datenbank: `mta_terratex_reallife`
--

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `admin_data_badwords`
--

CREATE TABLE IF NOT EXISTS `admin_data_badwords` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Beleidigung` varchar(250) NOT NULL,
  `Type` int(11) NOT NULL DEFAULT 0,
  `connectedTo` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `Beleidigung` (`Beleidigung`),
  KEY `connectedTo` (`connectedTo`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `admin_data_badwords`
--
...
(46, 'puta', 0, NULL),
(47, 'wixer', 1, 'wixxer'),
(48, 'nuttenbengel', 1, 'hurensohn');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `admin_dev_access`
--

CREATE TABLE IF NOT EXISTS `admin_dev_access` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `admin_user_bans`
--

CREATE TABLE IF NOT EXISTS `admin_user_bans` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `admin_user_paroles`
--

CREATE TABLE IF NOT EXISTS `admin_user_paroles` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `admin_user_timebans`
--

CREATE TABLE IF NOT EXISTS `admin_user_timebans` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `admin_user_warns`
--

CREATE TABLE IF NOT EXISTS `admin_user_warns` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `admin_whitelist`
--
...
--
-- Tabellenstruktur für Tabelle `admin_whitelist_multiaccounts`
--

CREATE TABLE IF NOT EXISTS `admin_whitelist_multiaccounts` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `data_advertising`
--

CREATE TABLE IF NOT EXISTS `data_advertising` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `data_chrismas`
--

CREATE TABLE IF NOT EXISTS `data_chrismas` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `data_crimes_categories`
--

CREATE TABLE IF NOT EXISTS `data_crimes_categories` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Daten für Tabelle `data_crimes_categories`
--

INSERT INTO `data_crimes_categories` (`ID`, `CategorieName`, `Order`, `hidden`) VALUES
(100, 'Kleinverbrechen', 100, 0),
(200, 'Verbrechen im Straßenverkehr', 200, 0),
(300, 'Transporte / Events / Gruppenverbrechen', 300, 0),
(400, 'Illegaler Besitz / Handel', 400, 0),
(500, 'Gewaltverbrechen / Verbrechen mit Waffen', 500, 0),
(900, 'Gebietsverstösse / Einbrüche', 900, 0),
(1000, 'Admincrimes', 1000, 1),
(1100, 'Additional System Crimes', 1100, 1);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `data_crimes_list`
--

CREATE TABLE IF NOT EXISTS `data_crimes_list` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Daten für Tabelle `data_crimes_list`
--

INSERT INTO `data_crimes_list` (`ID`, `CategorieID`, `Name`, `Percentage`, `MinPercentage`) VALUES
(100, 100, 'Notrufmissbrauch', 10, 5),
(101, 100, 'Sachbeschädigung', 10, 5),
(102, 100, '(versuchter) Diebstahl', 15, 7),
(103, 100, 'Ernstzunehmende Drohung', 10, 5),
(104, 100, 'versuchte Erpressung', 8, 2),
(105, 100, 'Behinderung von Beamtenarbeit', 8, 2),
(106, 100, 'Erregung öffentlichen Ärgernisses', 4, 2),
(200, 200, 'Illegales Straßenrennen', 20, 10),
(201, 200, 'Flucht aus einer Verkehrskontrolle', 20, 10),
(202, 200, 'Durchfahren einer Grenze ohne Maut zu Bezahlen', 25, 15),
(203, 200, 'Carsurfing', 15, 7),
(300, 300, 'Fahren eines Waffenmaterialtransportes', 45, 20),
(301, 300, 'Angriff auf einen Atommülltransporters', 45, 20),
(302, 300, 'Angriff auf einen Geldtransporter', 45, 20),
(303, 300, 'Angriff auf einen Alkatraztransport', 60, 30),
(304, 300, 'Flucht aus einem Alkatraztransport', 100, 50),
(305, 300, 'Geiselnahme', 45, 20),
(400, 400, 'Drogenkonsum (mehr als 15g im Blut)', 20, 10),
(401, 400, 'Drogenbesitz bis 50g', 15, 10),
(402, 400, 'Drogenbesitz ab 50g', 30, 20),
(403, 400, 'Drogenbesitz unbekannter Menge (weißes Päckchen)', 30, 20),
(404, 400, 'Drogenverkauf', 40, 20),
(405, 400, 'Waffenmaterialbesitz bis 100 Teile', 20, 10),
(406, 400, 'Waffenmaterialbesitz ab 100 Teile', 40, 20),
(407, 400, 'Waffenmaterialbesitz unbekannter Menge (klirrender Beutel)', 40, 20),
(408, 400, 'Waffenverkauf', 40, 20),
(409, 400, 'Illegale Werbung', 50, 25),
(500, 500, 'Körperverletzung', 10, 5),
(501, 500, 'Vorsätzliches Tragen von Schusswaffen in der Öffentlichkeit', 15, 5),
(502, 500, 'Waffennutzung / Beschuss', 20, 10),
(503, 500, 'Mord', 35, 15),
(504, 500, 'Mehrfachmord', 45, 25),
(505, 500, 'Terroranschlag', 80, 50),
(900, 900, 'Missachtung eines Platzverweises', 10, 2),
(901, 900, 'Unerlaubter Zutritt zu einer neutralen Fraktionsbasis', 20, 5),
(902, 900, 'Unerlaubter Zutritt zu internen SAPD Bereichen', 30, 10),
(903, 900, 'Unerlaubter Zutritt zur SEK Basis', 40, 15),
(904, 900, 'Unerlaubter Zutritt zu einer millitärischen Einrichtung', 75, 30),
(905, 900, 'Aufenthalt außerhalb von Los Santos ohne Reisepass', 10, 2),
(906, 900, 'Fehlender Personalausweis trotz Ausweispflicht in San Andreas (ab 25 Spielstunden)', 10, 2),
(907, 900, 'Unerlaubter Zutritt ins Atomkraftwerk', 30, 10),
(1000, 1000, 'SDM', 50, 50),
(1001, 1000, 'SDM - Extrem', 100, 100),
(1100, 1100, 'Zivilmord', 30, 10),
(1101, 1100, 'Zivilmord in Ruhezone', 40, 10);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `data_faq`
--
...
--
-- Daten für Tabelle `data_faq`
--

INSERT INTO `data_faq` (`ID`, `Frage`, `Antwort`, `katID`) VALUES
(1, 'Wie kann ich mein Passwort ändern?', 'Ein Ändern des Passworts ist derzeit nicht möglich.', 3),
(2, 'Wie kann ich mich in einer Fraktion bewerben?', 'Um dich bei einer Fraktion bewerben zu können, wende dich direkt an den Leader der jeweiligen Fraktion.', 4),
...
--
-- Tabellenstruktur für Tabelle `data_faq_category`
--

CREATE TABLE IF NOT EXISTS `data_faq_category` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Daten für Tabelle `data_faq_category`
--
...
--
-- Tabellenstruktur für Tabelle `data_jobnames`
--

CREATE TABLE IF NOT EXISTS `data_jobnames` (
  `ID` int(11) NOT NULL,
...
--
-- Daten für Tabelle `data_jobnames`
--
...
--
-- Tabellenstruktur für Tabelle `data_settings`
--
...
--
-- Daten für Tabelle `data_settings`
--

INSERT INTO `data_settings` (`Name`, `Wert`) VALUES
('atommuell', '76'),
('DailyReset', '1504317610'),
('drogenpreis', '75'),
('Jackpot', '6024098'),
('matspreis', '3'),
('regenlevel', '1.470000'),
...
('Version', 'reloaded-1.2.0');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `data_taxi_prices`
--

CREATE TABLE IF NOT EXISTS `data_taxi_prices` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Daten für Tabelle `data_taxi_prices`
--
...
--
-- Tabellenstruktur für Tabelle `faction_blacklist`
--
...
--
-- Daten für Tabelle `faction_blacklist`
--

INSERT INTO `faction_blacklist` (`ID`, `Name`, `Fraktion`, `Von`, `Grund`) VALUES
(26, 'zExplodZ', 12, 'Klobuerste', 'Beschuss');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `faction_gangfights`
--

CREATE TABLE IF NOT EXISTS `faction_gangfights` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(255) DEFAULT NULL,
...
--
-- Daten für Tabelle `faction_gangfights`
--

INSERT INTO `faction_gangfights` (`ID`, `Name`, `Type`, `Owner`, `X`, `Y`, `Z`, `RSmall`, `RLarge`, `ASpawnX`, `ASpawnY`, `ASpawnZ`, `HoursWithoutAttack`) VALUES
(1, 'Hauptammunation LS', 2, -1, 1366.2, -1287.23, 13.5469, 75, 276, 1187.37, -1324.97, 13.5594, 91),
(2, 'Ammunation Grove Street', 2, -1, 2400.28, -1980.83, 13.5469, 95, 185, 2351.43, -1906.5, 13.5469, 84),
(3, 'Crackbude ', 1, -1, 2179.8, -1661.5, 14.8945, 79, 272, 2332.08, -1770.15, 13.5564, 82),
(4, 'Drogenversteck am Glenpark', 1, -1, 1809.57, -1170, 23.8281, 71, 312, 1872.05, -1372.02, 13.5334, 90),
(5, 'Ammunation am Come-A-Lot', 2, -1, 2158.5, 943.379, 10.8203, 108, 396, 2284.13, 1200.71, 10.8203, 82),
(6, 'Hauptammunation LV', 2, -1, 2538.39, 2082.63, 10.8203, 112, 265, 2572.88, 2258.19, 10.8133, 82),
(7, 'Drogenversteck Süd LV', 1, -1, 2425.37, 1899.14, 6.01562, 198, 456, 2596.58, 1726.8, 10.3833, 82),
(8, 'Drogenversteck Nord LV', 1, -1, 2647.27, 828.799, 8.82031, 135, 398, 2632.43, 1079.42, 10.8203, 82);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `faction_inventory`
--
...
CREATE TABLE IF NOT EXISTS `faction_inventory` (
  ...
  `Tanksatz` int(11) DEFAULT 50,
  PRIMARY KEY (`FrakID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `faction_inventory`
--

INSERT INTO `faction_inventory` (`FrakID`, `Munition`, `Kasse`, `Drogen`, `Steuersatz`, `gehalt`, `max_members`, `Tanksatz`) VALUES
(1, 0, 1128450, 0, 1, 0, 30, 100),
(2, 1581290, 1244420, 272025, 1, 0, 15, 10),
(3, 0, 703092, 0, 7, 0, 20, 50),
(4, 0, 97754, 0, 1, 0, 20, 75),
(5, 0, 108413, 0, 1, 0, 20, 50),
(6, 236900, 6284, 31350, 1, 0, 15, 50),
(7, 0, 479352, 0, 5, 0, 20, 50),
(8, 0, 1634, 0, 1, 0, 20, 50),
(9, 0, 100866, 0, 1, 0, 20, 50),
(10, 0, 176682, 0, 2, 0, 20, 80),
(11, 40500, 199840, 11260, 1, 0, 15, 50),
(12, 775333, 724173, 35237, 5, 0, 15, 50),
(13, 28000, 9.58483, 200, 0, 0, 20, 50);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `faction_names`
--
...
--
-- Daten für Tabelle `faction_names`
--
...
--
-- Tabellenstruktur für Tabelle `faction_userrights`
--

CREATE TABLE IF NOT EXISTS `faction_userrights` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(250) CHARACTER SET latin1 NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `log_ad`
--

CREATE TABLE IF NOT EXISTS `log_ad` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(255) NOT NULL,
  `Text` longtext NOT NULL,
  `Datum` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
  KEY `log_ad_user_Nickname_fk` (`Nickname`)
) ENGINE=MyISAM AUTO_INCREMENT=2500 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_anonym`
--

CREATE TABLE IF NOT EXISTS `log_anonym` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `log_badword`
--

CREATE TABLE IF NOT EXISTS `log_badword` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(255) NOT NULL,
  ...
  PRIMARY KEY (`ID`),
  KEY `log_badword_user_Nickname_fk` (`Nickname`)
) ENGINE=MyISAM AUTO_INCREMENT=778 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_biz`
--
...
CREATE TABLE IF NOT EXISTS `log_biz` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=388755 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_car_deletes`
--

CREATE TABLE IF NOT EXISTS `log_car_deletes` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `TimeStamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Tabellenstruktur für Tabelle `log_casino`
--

CREATE TABLE IF NOT EXISTS `log_casino` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(255) NOT NULL,
  ...
  `datum` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
  KEY `log_casino_user_Nickname_fk` (`Nickname`)
) ENGINE=InnoDB AUTO_INCREMENT=182991 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `log_chat` (
  ...
  `Time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
  KEY `log_chat_user_Nickname_fk` (`Nickname`)
) ENGINE=MyISAM AUTO_INCREMENT=386582 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_delstvo`
--

CREATE TABLE IF NOT EXISTS `log_delstvo` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID`),
  KEY `log_delstvo_user_Nickname_fk` (`Von`),
  KEY `log_delstvo_user_wer_Nickname_fk` (`Wer`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_faction_inventory`
--

CREATE TABLE IF NOT EXISTS `log_faction_inventory` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Fraktion` int(11) NOT NULL DEFAULT 0,
  ...
  `Grund` text DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=88621 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_gold`
--
...
CREATE TABLE IF NOT EXISTS `log_gold` (
  ...
  `Grund` text DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `log_gold_user_Nickname_fk` (`Nickname`)
) ENGINE=InnoDB AUTO_INCREMENT=711 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_kills`
--

CREATE TABLE IF NOT EXISTS `log_kills` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `Timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3113 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_loosedriverlicense`
--

CREATE TABLE IF NOT EXISTS `log_loosedriverlicense` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(255) NOT NULL,
  `Fraktion` int(11) NOT NULL DEFAULT 0,
  `datum` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
  KEY `log_loosedriverlicense_user_Nickname_fk` (`Nickname`)
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_lotto`
--

CREATE TABLE IF NOT EXISTS `log_lotto` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Number1` int(11) DEFAULT NULL,
  `Number2` int(11) DEFAULT NULL,
  `Number3` int(11) DEFAULT NULL,
  `Winnerlist` text DEFAULT NULL,
...
--
-- Tabellenstruktur für Tabelle `log_playermoney`
--

CREATE TABLE IF NOT EXISTS `log_playermoney` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(250) NOT NULL,
  ...
  `Grund` text DEFAULT NULL,
  `GrundZusatz` text DEFAULT NULL,
  `Datum` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `DateStamp` int(11) NOT NULL DEFAULT 0,
  `AdditionalData` text DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `log_playermoney_user_Nickname_fk` (`Nickname`)
) ENGINE=InnoDB AUTO_INCREMENT=829195 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_playtime`
--
...
--
-- Tabellenstruktur für Tabelle `log_premium`
--

CREATE TABLE IF NOT EXISTS `log_premium` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(255) NOT NULL,
  `Datum` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `how` varchar(255) NOT NULL DEFAULT 'echtgeld',
  PRIMARY KEY (`ID`),
  KEY `log_premium_user_Nickname_fk` (`Nickname`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_serveradvertising`
--

CREATE TABLE IF NOT EXISTS `log_serveradvertising` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(255) NOT NULL,
  `Message` longtext NOT NULL,
  `Time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
  KEY `log_serveradvertising_user_Nickname_fk` (`Nickname`)
) ENGINE=MyISAM AUTO_INCREMENT=863 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_steuern`
--

CREATE TABLE IF NOT EXISTS `log_steuern` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(250) NOT NULL,
  `Type` varchar(250) NOT NULL,
  `Betrag` decimal(65,2) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `log_steuern_user_Nickname_fk` (`Nickname`)
) ENGINE=InnoDB AUTO_INCREMENT=33867 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `log_tow_police`
--

CREATE TABLE IF NOT EXISTS `log_tow_police` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `TimeStamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Owner` varchar(255) DEFAULT NULL,
...
--
-- Tabellenstruktur für Tabelle `objects_businesses`
--

CREATE TABLE IF NOT EXISTS `objects_businesses` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(255) NOT NULL,
  ...
  `y` float NOT NULL,
  `z` float NOT NULL,
  `PaidUntil` int(11) DEFAULT 0,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `objects_businesses`
--

INSERT INTO `objects_businesses` (`ID`, `Name`, `Preis`, `Kasse`, `x`, `y`, `z`, `PaidUntil`) VALUES
(1, 'Burgershot', 500000, 20956.3, 1206.24, -917.818, 43.076, 0),
(2, 'PizzaStack', 500000, 198.7, 2105.09, -1802.86, 13.5547, 0),
(3, 'CluckinBell', 500000, 700.4, 2420.71, -1503.81, 24, 0),
(4, 'Sprunk', 500000, 16, 2852.51, -1533.15, 11.0938, 0),
(5, 'PaynSpray', 500000, 591.223, 1029.19, -1030.36, 32.0561, 0),
(6, 'Tunning', 500000, 132007, 1047.45, -1027.11, 32.1016, 0),
(7, 'Tankstelle', 500000, 18724.2, 1010.41, -929.694, 42.3281, 0),
(8, '24/7', 500000, 7071.35, 1312.66, -898.358, 39.5781, 0),
(9, 'Bar & Strip Industries', 500000, 20086, 1835.75, -1687.61, 13.3765, 0),
(10, 'Unitel Telefon', 500000, 41274, 1579.45, -1854.68, 13.5127, 0),
(11, 'Los Santos Arena', 500000, 262.5, 2727.84, -1827.66, 11.8438, 0),
(12, 'SexShop', 500000, 92.43, 2086.43, 2080.12, 11.0579, 0),
(13, 'Caligulas Casino', 500000, 5755, 2194.57, 1682.27, 12.3672, 0),
(14, 'Maut', 500000, 20008.5, 1654, -51.6, 36.6, 0),
(15, 'Binco', 500000, 60005.1, 458.7, -1495.3, 31.1, 0),
(16, 'Tombupot Lotterie', 500000, 0, 1628.5, -1171.5, 24.1, 0);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `objects_drivein`
--

CREATE TABLE IF NOT EXISTS `objects_drivein` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `x` float NOT NULL,
  `y` float NOT NULL,
  `z` float NOT NULL,
  `size` float NOT NULL DEFAULT 4,
  `typ` varchar(255) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `objects_drivein`
--

INSERT INTO `objects_drivein` (`ID`, `x`, `y`, `z`, `size`, `typ`) VALUES
(2, 1214.11, -904.675, 41.9216, 4, 'burger'),
(3, 2411.4, -1488.34, 22.8281, 4, 'huhn'),
(4, 2396.53, -1917.86, 12.3828, 4, 'huhn'),
(5, 1856.77, 2082.12, 9.52797, 4, 'burger'),
(6, 1168.47, 2083.04, 9.52502, 4, 'burger'),
(7, 2486.99, 2021.15, 9.52592, 4, 'burger'),
(8, -2345.55, 1022.41, 49.4006, 4, 'burger'),
(9, -2352.52, -153.615, 34.0248, 4, 'burger'),
(10, 800.689, -1629.59, 12.0874, 4, 'burger'),
(11, 1766.61, -1892.13, 13, 1, 'pizza');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `objects_events_pickups`
--

CREATE TABLE IF NOT EXISTS `objects_events_pickups` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID`),
  KEY `gefundenVon` (`gefundenVon`),
  KEY `event` (`event`)
) ENGINE=InnoDB AUTO_INCREMENT=4543 DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `objects_events_pickups`
--
...
--
-- Tabellenstruktur für Tabelle `objects_fuel_stations`
--

CREATE TABLE IF NOT EXISTS `objects_fuel_stations` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Daten für Tabelle `objects_fuel_stations`
--

INSERT INTO `objects_fuel_stations` (`ID`, `GasPumps`, `Price`) VALUES
(59, '[[{\"x\" : -94.0146484375, \"y\":-1175.1796875, \"z\":1.9937258958817, \"size\":2}]]', 8.283),
(60, '[[{\"x\" : -100.0068359375, \"y\":-1172.4462890625, \"z\":2.1999135017395, \"size\":2}]]', 10.143),
(61, '[[{\"x\" : -2244.3984375, \"y\":-2561.1142578125, \"z\":31.648958206177, \"size\":2}]]', 10.524),
(62, '[[{\"x\" : -2029.322265625, \"y\":157.6513671875, \"z\":28.563018798828, \"size\":2}]]', 7.294),
(63, '[[{\"x\" : -1466.109375, \"y\":1863.4296875, \"z\":32.36164855957, \"size\":2}]]', 4.721),
(64, '[[{\"x\" : -1674.6298828125, \"y\":404.2578125, \"z\":7.1708655357361, \"size\":2}]]', 11.813),
(65, '[[{\"x\" : 70.408203125, \"y\":1218.744140625, \"z\":18.53918838501, \"size\":2}]]', 7.279),
(66, '[[{\"x\" : 2145.826171875, \"y\":2750.6884765625, \"z\":10.547393798828, \"size\":2}]]', 9.559),
(67, '[[{\"x\" : 2638.873046875, \"y\":1104.259765625, \"z\":10.543460845947, \"size\":2}]]', 6.182),
(68, '[[{\"x\" : 2115.998046875, \"y\":922.5361328125, \"z\":10.547393798828, \"size\":2}]]', 14.409),
(69, '[[{\"x\" : 1594.5703125, \"y\":2206.6318359375, \"z\":10.547393798828, \"size\":2}]]', 9.071),
(70, '[[{\"x\" : 1485.7421875, \"y\":-2425.939453125, \"z\":13.5546875, \"size\":6}]]', 6.261),
(71, '[[{\"x\" : 658.2744140625, \"y\":-560.224609375, \"z\":16.063018798828, \"size\":2}]]', 12.92),
(72, '[[{\"x\" : 1005.279296875, \"y\":-933.251953125, \"z\":41.1796875, \"size\":2}]]', 7.93),
(73, '[[{\"x\" : 1938.9326171875, \"y\":-1773.38671875, \"z\":12.3828125, \"size\":2}]]', 8.075),
(74, '[[{\"x\" : 2311.5166015625, \"y\":-2420.005859375, \"z\":-0.26488932967186, \"size\":6}]]', 10.529),
(75, '[[{\"x\" : 2199.6396484375, \"y\":2474.56640625, \"z\":10.8203125, \"size\":2}]]', 13.406),
(76, '[[{\"x\" : -1114.0859375, \"y\":-174.078125, \"z\":14.24893283844, \"size\":6}]]', 8.606),
(77, '[[{\"x\" : 1638.0517578125, \"y\":554.4462890625, \"z\":-0.74756044149399, \"size\":6}]]', 10.006),
(78, '[[{\"x\" : 1300.533203125, \"y\":1436.0380859375, \"z\":10.910797119141, \"size\":6}]]', 7.874),
(79, '[[{\"x\" : 300.2060546875, \"y\":2065.2939453125, \"z\":17.640625, \"size\":3}]]', 10.904),
(80, '[[{\"x\" : 1643.57, \"y\":83.45, \"z\":36.1, \"size\":2}, {\"x\" : 1642.3, \"y\":77.95, \"z\":36.1, \"size\":2}]]', 4.241),
(81, '[[{\"x\" : -1609.7587890625, \"y\":-2718.27734375, \"z\":48.266124725342, \"size\":2},{\"x\" : -1603.6376953125, \"y\":-2709.052734375, \"z\":48.261840820312, \"size\":2}]]', 10.56),
(82, '[[{\"x\" : -2414.8896484375, \"y\":975.119140625, \"z\":45.023956298828, \"size\":2},{\"x\" : -2406.9833984375, \"y\":971.8740234375, \"z\":45.02632522583, \"size\":2}]]', 11.039),
(83, '[[{\"x\" : -1674.1083984375, \"y\":418.0009765625, \"z\":7.1729331016541, \"size\":2},{\"x\" : -1674.6298828125, \"y\":404.2578125, \"z\":7.1708655357361, \"size\":2}]]', 13.671),
(84, '[[{\"x\" : 621.5537109375, \"y\":1679.708984375, \"z\":6.7192716598511, \"size\":2},{\"x\" : 609.0615234375, \"y\":1699.529296875, \"z\":6.7210984230042, \"size\":2},{\"x\" : 615.46875, \"y\":1690.236328125, \"z\":6.7192645072937, \"size\":2}]]', 2.811),
(85, '[[{\"x\" : -1329.486328125, \"y\":2671.9453125, \"z\":49.789577484131, \"size\":2},{\"x\" : -1327.01953125, \"y\":2682.8017578125, \"z\":49.789585113525, \"size\":2}]]', 8.485);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `objects_houses`
--

CREATE TABLE IF NOT EXISTS `objects_houses` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `Beschreibung` text DEFAULT NULL COMMENT 'Beschreibung für DB',
  PRIMARY KEY (`ID`),
  KEY `IRID` (`IRID`),
  KEY `IRID_2` (`IRID`)
...
--
-- Daten für Tabelle `objects_houses`
--

INSERT INTO `objects_houses` (`ID`, `IRID`, `CoordX`, `CoordY`, `CoordZ`, `Preis`, `Miete`, `Kasse`, `city`, `QM`, `Stockwerke`, `Wert`, `Beschreibung`) VALUES
(1, 0, 1653.96, -1655.43, 22.5156, 10000000, 1200, 12900, 0, 2500, 26, 2, 'Geramys Haus'),
(2, 0, 2067.96, -1628.97, 13.8762, 28000, 0, 0, 0, 126, 1, 0, 'GroveStreet'),
(3, 0, 2068.19, -1643.9, 13.8058, 25000, 0, 0, 0, 101, 1, 0, 'Grove Street'),
(4, 0, 254.841, -1367.02, 53.1094, 1800000, 750, 0, 0, 518, 2, 2, 'Villa Vinewood'),
(5, 0, 298.242, -1338.05, 53.4415, 1200000, 500, 0, 0, 200, 2, 2, 'Villa Vinewood'),
(6, 0, 2479.62, -1063.83, 66.9982, 16000, 0, 300, 0, 65, 1, 0, 'gammelwood'),
(7, 0, 827.991, -858.31, 70.3308, 500000, 0, 0, 0, 190, 1, 1, 'Vinewood'),
(8, 0, 980.477, -677.268, 121.976, 3500000, 100, 0, 0, 680, 3, 2, 'Vinewoodvilla'),
(9, 0, 657.229, -1652.62, 15.4062, 52000, 300, 79, 0, 147, 1, 0, 'Beach'),
(10, 0, 1981.61, -1682.93, 17.0538, 350000, 100, 0, 0, 174, 2, 1, 'Alhambra'),
(11, 0, 1421.76, -886.055, 50.6798, 560000, 100, 0, 0, 242, 2, 1, 'vinewood'),
(12, 0, 2808.07, -1176.04, 25.3798, 420000, 60, 0, 0, 358, 2, 1, 'Stand-bohrinsel'),
(13, 0, 2808.16, -1190.38, 25.3402, 420000, 600, 0, 0, 358, 2, 1, 'strand-bohrinsel'),
(14, 0, 1242.37, -1075.36, 31.5547, 650000, 100, 0, 0, 227, 3, 1, 'Nahe Bank'),
(15, 0, 1285.1, -1065.78, 31.6789, 650000, 100, 0, 0, 227, 3, 1, 'bank'),
(16, 0, 1242.45, -1100.55, 27.9766, 650000, 250, 0, 0, 227, 3, 1, 'bank'),
(17, 0, 1285.02, -1091.39, 28.2578, 650000, 0, 0, 0, 227, 3, 1, 'bank'),
(18, 0, 870.386, -25.2002, 63.9635, 10000, 100, 22, 2, 50, 1, 0, 'im wald'),
(19, 0, 645.976, -1117.43, 44.207, 1200000, 100, 0, 0, 555, 1, 2, 'Vinewood'),
(20, 0, 1684.96, -2098.16, 13.8343, 65000, 300, 5281, 0, 152, 1, 0, 'bahnhof'),
(21, 0, 2290.52, -1796.02, 13.5469, 220000, 1, 0, 0, 266, 2, 0, 'arena'),
(22, 0, 2307.53, -1785.73, 13.5569, 220000, 100, 0, 0, 226, 2, 0, 'arena'),
(23, 0, 300.303, -1154.51, 81.391, 3200000, 1000, 0, 0, 580, 2, 2, 'tommys haus'),
(24, 0, 1298.49, -798.503, 84.1406, 5000000, 0, 0, 0, 1500, 3, 2, 'Maddogs'),
(25, 0, 2287.52, -1080.9, 48.1097, 90000, 100, 0, 0, 428, 2, 0, 'komisches haus'),
(26, 0, -2552.03, 2266.58, 5.47552, 450000, 0, 0, 2, 140, 1, 1, 'Haus in Bayside'),
(27, 0, -2523.69, 2239.19, 5.39844, 490000, 350, 0, 2, 190, 1, 1, 'bayside'),
(28, 0, 1715.19, -2124.83, 14.0566, 85000, 250, 370, 0, 174, 1, 0, 'airportgegend'),
(29, 0, 1332.05, -633.037, 109.135, 2250000, 100, 0, 0, 265, 1, 2, 'vinewood'),
(30, 0, 977.623, -771.456, 112.203, 2500000, 100, 0, 0, 273, 2, 2, 'Vinewood Holzhaus'),
(31, 0, 2782.17, -1306.42, 38.8717, 987654, 100, 0, 0, 262, 3, 1, 'am strand'),
(32, 0, 2393.11, -1646.04, 13.9051, 12000, 0, 0, 0, 156, 1, 0, 'grove street'),
(33, 0, 1468.42, -906.004, 54.8359, 1400000, 100, 0, 0, 286, 2, 1, 'Vinewood'),
(34, 0, 2306.92, -1679.2, 14.3316, 15500, 0, 0, 0, 110, 1, 0, 'grovestreet'),
(35, 0, 1497.11, -688.86, 95.2309, 3800000, 500, 0, 0, 632, 2, 2, 'vinewood'),
(36, 0, 1535.03, -800.355, 72.8495, 455000, 100, 0, 0, 180, 1, 1, 'vinewood'),
(37, 0, 2334.69, -1234.66, 27.9766, 254000, 0, 0, 0, 262, 2, 0, 'gammelwood'),
(38, 0, 2324.3, -1218.91, 27.9766, 254000, 500, 1609, 0, 262, 2, 0, 'gammelwood'),
(39, 0, 559.029, -1076.11, 72.922, 574322, 1000, 21000, 0, 276, 2, 1, 'vinewood'),
(40, 0, 1106.22, -299.678, 74.5391, 921000, 550, 0, 2, 100, 1, 0, 'farm'),
(41, 0, 985.413, 1901.15, 11.4609, 434000, 100, 0, 1, 175, 1, 1, 'lv'),
(42, 0, 1045.15, -642.922, 120.117, 1150000, 800, 0, 0, 175, 2, 2, 'vinewood'),
(43, 0, 1095.25, -647.894, 113.648, 1950000, 800, 600, 0, 325, 2, 2, 'vinewood'),
(44, 0, 1030.79, 1928.15, 11.4683, 222000, 100, 0, 1, 231, 1, 0, 'lv'),
(45, 0, 2363.12, 142.085, 28.4416, 250000, 250, 0, 2, 94, 1, 1, 'mafiastadt'),
(46, 0, 2368.44, -1675.15, 14.1682, 25123, 0, 0, 0, 185, 1, 0, 'grovestreet'),
(47, 0, 2017.67, -1703.22, 14.2344, 14000, 0, 0, 0, 85, 1, 0, 'grovestreet'),
(48, 0, 700.372, -1060.02, 49.4217, 1652300, 0, 0, 0, 472, 2, 2, 'vinewood'),
(49, 0, -910.938, 2685.94, 42.3703, 1500000, 100, 0, 2, 170, 1, 1, 'bootshaus'),
(50, 0, 745.668, -591.004, 18.0129, 500600, 600, 14100, 2, 195, 1, 1, 'mafia'),
(51, 0, 2067.05, -1731.71, 14.2066, 23000, 0, 0, 0, 101, 1, 0, 'grovestreet'),
(52, 0, 2465.37, -2020.77, 14.1242, 15000, 0, 0, 0, 155, 1, 0, 'noch gammeligeres wood'),
(53, 0, 2518.35, 128.983, 27.6756, 200000, 0, 0, 2, 97, 1, 1, 'mafia'),
(54, 5, 2065.12, -1703.55, 14.1484, 35000, 250, 0, 0, 116, 1, 0, 'grovestreet'),
(55, 0, 315.673, -1769.89, 4.63275, 1320000, 600, 1600, 0, 165, 3, 1, 'strand fischer'),
(56, 0, 252.997, -1269.89, 74.3378, 1750000, 2000, 0, 0, 510, 2, 2, 'vinewood'),
(57, 0, 835.891, -894.812, 68.7689, 1900000, 500, 0, 0, 247, 2, 2, 'vinewood'),
(58, 0, 946.239, -710.49, 122.62, 850000, 0, 0, 0, 167, 1, 1, 'vinewood'),
(59, 0, 1034.82, -812.811, 101.852, 1400000, 720, 0, 0, 286, 2, 1, 'vinewood'),
(60, 0, 2016.33, -1641.58, 13.7824, 25000, 200, 6176, 0, 102, 1, 0, 'grovestreet'),
(61, 0, 189.659, -1308.33, 70.2497, 3800000, 100, 0, 0, 656, 2, 2, 'vinewood'),
(62, 0, 1925.53, 663.599, 10.8203, 170000, 150, 50, 1, 170, 1, 1, 'lv'),
(63, 0, 1929.23, 742.657, 10.8203, 170000, 2000, 0, 1, 170, 1, 1, 'lv'),
(64, 0, 1956.82, 738.087, 10.8203, 170000, 100, 0, 1, 170, 1, 1, 'lv'),
(65, 0, 1957.01, 691.37, 10.8203, 170000, 200, 0, 1, 170, 1, 1, 'lv'),
(66, 0, 1896.77, 736.583, 14.2763, 170000, 0, 0, 1, 170, 1, 1, 'lv'),
(67, 0, 1896.74, 669.854, 14.2762, 170000, 200, 0, 1, 170, 1, 1, 'lv'),
(68, 0, 2245.57, -122.291, 28.1535, 200000, 5, 0, 2, 97, 1, 1, 'mafia'),
(69, 0, 2203.13, -89.2988, 28.1535, 200000, 250, 0, 2, 97, 1, 1, 'mafia'),
(70, 0, 724.743, -999.398, 52.7344, 1250000, 750, 847, 0, 225, 2, 1, 'vinewood'),
(71, 0, 251.338, -1220.3, 76.1024, 3100000, 100, 0, 0, 610, 2, 2, 'vinewood'),
(72, 0, 808.247, -759.268, 76.5314, 850000, 100, 0, 0, 285, 2, 1, 'vinewood'),
(73, 0, 2782.07, -1333.25, 32.3715, 987654, 100, 0, 0, 262, 3, 1, 'strand'),
(74, 0, 1059.04, -1105.42, 28.0451, 463000, 555, 1485, 0, 190, 1, 1, 'tuning'),
(75, 0, 2415.39, -52.2822, 28.1535, 200000, 1000, 2992, 2, 97, 1, 1, 'mafia'),
(76, 0, 2438.9, -54.9648, 28.1535, 200000, 0, 0, 2, 97, 1, 1, 'mafia'),
(77, 0, 2392.5, -54.9121, 28.1536, 200000, 250, 0, 2, 97, 1, 1, 'mafia'),
(78, 0, 2367.42, -49.125, 28.1535, 200000, 300, 146, 2, 97, 1, 1, 'mafia'),
(79, 0, 2438.66, -1105.53, 42.7512, 27000, 0, 0, 0, 101, 1, 0, 'gammelwood'),
(80, 0, 2457.17, -1102.5, 43.8672, 34000, 0, 0, 0, 120, 1, 0, 'gammelwood'),
(81, 0, 910.283, -817.364, 103.126, 450000, 100, 0, 0, 150, 2, 1, 'vinewood'),
(82, 0, 1938.54, -1911.24, 15.2568, 300000, 200, 0, 0, 80, 1, 1, 'bahnhof'),
(83, 0, 852.35, -1422.78, 14.1176, 750000, 100, 0, 0, 335, 2, 1, ''),
(84, 0, 2091.32, -1278.92, 26.1543, 350000, 0, 0, 0, 100, 1, 1, 'glenpark'),
(85, 0, 2257.24, -1643.97, 15.8082, 18500, 1000, 6628, 0, 100, 1, 0, 'grove'),
(86, 0, 2282.22, -1641.49, 15.8898, 18500, 50, 446, 0, 101, 1, 0, 'grove'),
(87, 0, 2249.91, -1238.92, 25.8984, 14000, 150, 3486, 0, 72, 1, 0, 'grove'),
(88, 0, 219.319, -1249.74, 78.336, 2820000, 100, 0, 0, 510, 2, 2, 'vinewood'),
(89, 0, 652.363, -1694.17, 14.5603, 250000, 150, 0, 0, 140, 2, 1, 'kp'),
(90, 0, 1928.95, 2774.5, 10.8203, 650000, 100, 0, 1, 513, 2, 1, 'lv'),
(91, 0, 2000.19, -1114.77, 27.125, 500000, 300, 0, 0, 273, 2, 1, 'glenpark'),
(92, 0, 1905.8, -1112.95, 26.6641, 160000, 0, 0, 0, 140, 1, 1, 'glenpark'),
(93, 0, 2272.28, -118.276, 28.1535, 200000, 250, 0, 2, 97, 1, 1, 'mafia'),
(94, 0, 2407.78, -1106.97, 40.2957, 75000, 0, 0, 0, 143, 1, 0, 'gammelwood'),
(95, 0, 228.096, -1405.52, 51.6094, 450000, 100, 0, 0, 163, 1, 1, 'vinewood'),
(96, 0, 2326.63, -1717.16, 13.9074, 18500, 200, 587, 0, 110, 1, 0, 'grove'),
(97, 0, 2244.33, -1637.75, 15.9074, 18500, 10000, 1355, 0, 110, 1, 0, 'grove'),
(98, 0, 2013.58, -1656.12, 14.1363, 29000, 0, 0, 0, 102, 1, 0, 'asd'),
(99, 0, 1287.24, -867.874, 46.8361, 250000, 100, 0, 0, 119, 1, 1, 'bsn'),
(100, 0, 1280.83, -874.654, 46.8438, 250000, 100, 0, 0, 119, 1, 1, 'bsn'),
(101, 0, 1291.02, -896.865, 46.6251, 250000, 100, 0, 0, 119, 1, 1, 'bsn'),
(102, 0, 1242.1, -878.105, 46.6406, 250000, 100, 0, 0, 119, 1, 1, 'bsn'),
(103, 0, 2551.07, 57.2842, 27.6756, 211000, 250, 0, 2, 97, 1, 1, 'mafia'),
(104, 0, -2706.51, 864.772, 70.7031, 550000, 100, 0, 2, 300, 2, 1, 'sf'),
(105, 0, 1142.01, -1068.71, 31.7656, 705000, 100, 0, 0, 227, 3, 1, 'bank'),
(106, 0, 822.421, -1505.17, 14.3936, 950000, 0, 0, 0, 500, 2, 1, 'beach'),
(107, 0, 1939.14, -1114.48, 27.4523, 170000, 600, 59360, 0, 120, 1, 1, 'glen'),
(108, 0, 2327.27, -1681.8, 14.9297, 19612, 0, 0, 0, 145, 1, 0, 'grove'),
(109, 0, 2507.65, -2020.74, 14.2101, 20000, 0, 150, 0, 155, 1, 0, 'gammel'),
(110, 0, -2437.48, 2354.68, 5.44307, 321125, 0, 0, 2, 240, 1, 0, 'bay'),
(111, 0, 1967.34, 2766.39, 10.8265, 650000, 100, 0, 1, 296, 2, 1, 'lv'),
(112, 0, 1112.59, -741.969, 100.133, 785000, 550, 400, 0, 253, 2, 1, 'vinewood'),
(113, 0, -2662.13, 877.042, 79.7738, 1010101, 0, 0, 2, 375, 2, 1, 'sf'),
(114, 0, 848.258, -745.317, 94.9693, 450000, 100, 0, 0, 201, 2, 0, 'vinewood'),
(115, 0, 785.885, -828.583, 70.2896, 650000, 0, 0, 0, 201, 2, 0, 'vinewood'),
(116, 0, 2696.31, -1990.36, 14.2229, 150000, 50, 0, 0, 180, 1, 0, 'ls'),
(117, 0, 1378.56, -1753.06, 14.1406, 1512313, 700, 9500, 0, 373, 2, 1, 'stadthalle'),
(118, 0, -2710.93, 967.471, 54.4609, 900000, 100, 0, 2, 209, 1, 2, 'sf'),
(119, 0, 2842.15, -1334.79, 14.7421, 375000, 100, 0, 2, 192, 1, 1, 'beach'),
(120, 0, 1980.38, -1719.02, 17.0304, 350000, 0, 0, 0, 165, 2, 1, 'asd'),
(121, 0, 841.422, -1471.37, 14.3116, 950000, 100, 0, 0, 500, 2, 1, 'asd'),
(122, 0, 1928.7, -1916.14, 15.2568, 311000, 100, 0, 0, 80, 1, 1, 'asd'),
(123, 0, 937.849, -848.31, 93.6309, 850000, 100, 0, 0, 180, 2, 1, 'vinewood'),
(124, 0, 1540.24, -851.521, 64.3361, 785000, 500, 0, 0, 253, 2, 1, 'asd'),
(125, 0, 768.08, -1655.89, 5.60938, 350000, 500, 0, 0, 152, 1, 1, 'am kanal'),
(126, 0, 1443.25, -628.837, 95.7186, 2300000, 100, 0, 0, 560, 2, 2, 'vinew'),
(127, 0, 891.31, -783.106, 101.314, 1500000, 100, 0, 0, 260, 1, 2, 'vine'),
(128, 0, 1274.36, 2522.55, 10.8203, 650000, 500, 0, 1, 296, 2, 1, 'asd'),
(129, 0, 766.924, -1605.83, 13.8039, 350000, 20000, 0, 0, 152, 1, 1, 'asd'),
(130, 0, -2348.3, 2423.55, 7.32946, 1500000, 100, 0, 2, 182, 2, 2, 'bayside'),
(131, 0, 497.229, -1095.03, 82.3592, 2350000, 100, 0, 0, 560, 2, 2, 'vinewood'),
(132, 0, 1527.23, -773.154, 80.5781, 495000, 0, 0, 0, 180, 1, 1, 'vinewood');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `objects_houses_rooms`
--

CREATE TABLE IF NOT EXISTS `objects_houses_rooms` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `CoordX` float NOT NULL DEFAULT 0,
  `CoordY` float NOT NULL DEFAULT 0,
  `CoordZ` float NOT NULL DEFAULT 0,
  ...
  `Stockwerke` int(11) NOT NULL DEFAULT 0,
  `Wert` int(11) NOT NULL DEFAULT 0 COMMENT '0=> Arm; 1=> Mittel; 2=> Luxus',
  `Beschreibung` text DEFAULT NULL COMMENT 'Beschreibender Text für DB',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=latin1;

--
-- Daten für Tabelle `objects_houses_rooms`
--
...
--
-- Tabellenstruktur für Tabelle `objects_houses_wishes`
--

CREATE TABLE IF NOT EXISTS `objects_houses_wishes` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(250) NOT NULL,
  `x` float NOT NULL,
  `y` float NOT NULL,
...
--
-- Daten für Tabelle `objects_houses_wishes`
--

INSERT INTO `objects_houses_wishes` (`ID`, `Nickname`, `x`, `y`, `z`, `datum`, `unixtimestamp`) VALUES
(1, 'simon', -433.793, 1198.46, 8.82852, '2016-06-21 22:19:40', 1466547580),
(2, 'Jackass', -311.118, 1303.37, 53.6643, '2016-07-09 01:06:20', 1468026380),
(3, 'Snow', 1953.62, 1343.04, 15.3746, '2016-07-15 23:29:31', 1468625371),
(4, 'Al_Capone', 1999.23, -1737.37, 13.0777, '2016-07-16 18:08:20', 1468692500),
(5, 'byReaper', 1695.53, -2125.84, 13.8101, '2016-07-28 18:44:27', 1469731467),
(6, 'BroS', 743.336, -509.319, 18.0129, '2016-08-05 00:35:31', 1470357331),
(7, 'Kacper', -691.428, 938.613, 13.6328, '2016-08-05 19:54:35', 1470426875),
(9, 'Bob', 1804.37, -2124.15, 13.9424, '2016-08-08 14:55:07', 1470668107),
(10, 'Company', 2385.32, -1711.66, 14.2422, '2016-08-16 00:19:59', 1471306799),
(11, 'Kenny', 2494.3, -1704.65, 1018.34, '2016-08-20 13:22:22', 1471699342),
(12, 'ImKazuko', -1300.58, 2516.38, 86.9514, '2016-08-22 00:29:43', 1471825783),
(13, 'Blackcry007', 1429.22, 2654.14, 11.3926, '2016-08-22 17:49:08', 1471888148),
(14, 'TechnoWolf', 2774.89, -2481.35, 18.2308, '2016-08-22 18:39:19', 1471891159),
(15, 'Deeja', 2384.44, -1675.83, 15.2457, '2016-08-23 18:49:45', 1471978185),
(16, '[TTeam]Spiderblood', 2019.32, 1007.8, 10.8203, '2016-08-23 19:59:08', 1471982348),
(17, 'Jackass', 1093.85, -806.65, 107.419, '2016-08-24 16:22:13', 1472055733),
(18, 'John.Gotti', 818.228, -509.318, 18.0129, '2016-08-28 15:19:02', 1472397542),
(19, 'Arafat', 795.057, -506.92, 18.0129, '2016-08-28 15:19:19', 1472397559),
(20, 'Phil', 693.784, -1645.68, 4.09375, '2016-08-29 19:50:11', 1472500211),
(21, 'byReaper', 697.286, -1627, 3.74917, '2016-08-29 19:50:40', 1472500240),
(22, 'Al_Capone', 2498.88, -952.4, 82.2638, '2016-08-31 16:40:15', 1472661615),
(23, 'Elit3', 2111.03, -1279.89, 25.2487, '2016-09-11 17:55:34', 1473616534),
(24, 'SchruppidiWuppidi', 2022.94, -1122.39, 26.2031, '2016-09-11 18:04:21', 1473617061),
(25, 'Snudely', 2147.78, -1366.73, 25.6418, '2016-09-29 19:21:02', 1475176862),
(26, 'McProper', -2640.84, 935.718, 71.9531, '2016-09-30 17:24:18', 1475256258),
(27, 'HomelyBackpack51', 867.329, -716.843, 105.68, '2016-10-30 13:11:33', 1477833093),
(28, 'Grafit', 2650.7, -2021.71, 14.1766, '2016-11-21 20:53:22', 1479761602),
(29, 'Sentinel', 2672.72, -1989.75, 13.9935, '2016-11-21 20:55:30', 1479761730),
(30, 'GermanyGamerxD', 2653.01, -1990.2, 13.737, '2016-11-21 20:58:14', 1479761894);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `objects_prestiges`
--

CREATE TABLE IF NOT EXISTS `objects_prestiges` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `x` float NOT NULL,
  `y` float NOT NULL,
  `z` float NOT NULL,
...
--
-- Daten für Tabelle `objects_prestiges`
--
...
(5, 1573.92, -1329.1, 16.4844, 1, 'Star Tower', 850000, 883030, 850000),
(6, 2096.26, 1285.05, 10.8203, 1, 'Monument ', 450000, 467487, 450000),
(7, 2009.25, 1544.67, 12.5529, 1, 'Piratenschiff ', 500000, 595500, 500000),
...
(10, 927.96, -1209.37, 16.9564, 1, 'Filmstudio ', 600000, 780740, 600000),
...
(13, 1969.17, -1197.42, 18.7061, 1, 'Glenpark ', 450000, 467487, 450000),
(14, 1918.15, -1409.29, 13.5703, 1, 'Skaterpark ', 150000, 165535, 150000),
(15, 1129.13, -1488.45, 22.769, 1, 'Mall ', 750000, 4735550, 750000),
(16, 2184.31, 1114.27, 12.6484, 1, 'Come-A-Lot ', 1500000, 1558290, 1500000),
(17, 3106.76, -2145.43, 30.8122, 1, 'Bohrinsel ', 450000, 719194, 450000),
(18, -2696.43, 1933.87, 217.274, 1, 'Golden Gate Bridge', 1000000, 1301230, 1000000),
(19, -2232.24, -1738.11, 480.84, 1, 'Mount Chilliad', 12000000, 14292000, 12000000);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `objects_restareas`
--

CREATE TABLE IF NOT EXISTS `objects_restareas` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Daten für Tabelle `objects_restareas`
--
...
--
-- Tabellenstruktur für Tabelle `objects_sprunk`
--

CREATE TABLE IF NOT EXISTS `objects_sprunk` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `X` float NOT NULL,
  `Y` float NOT NULL,
  `Z` float NOT NULL,
...
--
-- Daten für Tabelle `objects_sprunk`
--
...
(50, -19.084, -57.047, 1003.55, 180, '24/7 Shop 2'),
(51, -19.084, -57.047, 1003.55, 180, '24/7 Shop 2');

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `objects_teleport_markers`
--

CREATE TABLE IF NOT EXISTS `objects_teleport_markers` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `x` float NOT NULL,
  `y` float NOT NULL,
  `z` float NOT NULL,
...
--
-- Daten für Tabelle `objects_teleport_markers`
--
...
(40, 1317.09, -1683.29, 1482.05, 1, 0, 'corona', '2.0', 39, NULL, NULL, NULL, NULL, 0, 0, NULL, 'Cinema entrance 1 Inside'),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `Gender` varchar(20) DEFAULT 'anonym',
  PRIMARY KEY (`ID`),
...
--
-- Tabellenstruktur für Tabelle `user_crimes`
--

CREATE TABLE IF NOT EXISTS `user_crimes` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(255) DEFAULT NULL,
  `CrimeID` int(11) DEFAULT NULL,
  `CrimePercentage` int(11) DEFAULT NULL,
  `AdditionalReason` text DEFAULT NULL,
  `Timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `user_data` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `Nickname` (`Nickname`),
  KEY `verheiratet` (`verheiratet`),
  KEY `verheiratet_2` (`verheiratet`)
) ENGINE=InnoDB AUTO_INCREMENT=1140 DEFAULT CHARSET=latin1;
...
--
-- Tabellenstruktur für Tabelle `user_gifts`
--
...
--
-- Tabellenstruktur für Tabelle `user_gold`
--
...
--
-- Tabellenstruktur für Tabelle `user_grades`
--
...
--
-- Tabellenstruktur für Tabelle `user_jobskills`
--

CREATE TABLE IF NOT EXISTS `user_jobskills` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_licenses` (
  ...
  `industrialFishingLic` int(1) DEFAULT 0,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `Nickname` (`Nickname`)
) ENGINE=InnoDB AUTO_INCREMENT=1140 DEFAULT CHARSET=latin1;
...
--
-- Tabellenstruktur für Tabelle `user_offline_data`
--
...
--
-- Tabellenstruktur für Tabelle `user_offline_messages`
--

CREATE TABLE IF NOT EXISTS `user_offline_messages` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID`),
  KEY `Nickname` (`Nickname`)
) ENGINE=InnoDB AUTO_INCREMENT=3370 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `user_tapps`
--

CREATE TABLE IF NOT EXISTS `user_tapps` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(255) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `user_tapps_friendlist`
--

CREATE TABLE IF NOT EXISTS `user_tapps_friendlist` (
  `Nickname` varchar(255) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `user_tapps_friendlist_request`
--

CREATE TABLE IF NOT EXISTS `user_tapps_friendlist_request` (
...
--
-- Tabellenstruktur für Tabelle `user_tapps_tictactoe`
--

CREATE TABLE IF NOT EXISTS `user_tapps_tictactoe` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(250) CHARACTER SET latin1 NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `user_tombupot`
--

CREATE TABLE IF NOT EXISTS `user_tombupot` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nickname` varchar(255) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `Nickname` (`Nickname`)
...
CREATE TABLE IF NOT EXISTS `user_vehicles` (
  ...
  `lastHealth` float DEFAULT 1000,
  `lastPosition` varchar(255) DEFAULT '[{0,0,0,0,0,0}]',
  `lastDamageStates` varchar(512) DEFAULT '[{}]',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `Unique` (`Besitzer`,`SlotID`)
...
--
-- Constraints der Tabelle `admin_data_badwords`
--
...
--
-- Constraints der Tabelle `admin_user_paroles`
--
...
--
-- Constraints der Tabelle `admin_user_timebans`
--
...
--
-- Constraints der Tabelle `admin_user_warns`
--
...
--
-- Constraints der Tabelle `admin_whitelist`
--
...
--
-- Constraints der Tabelle `data_chrismas`
--
ALTER TABLE `data_chrismas`
  ADD CONSTRAINT `data_chrismas_user_Nickname_fk` FOREIGN KEY (`Nickname`) REFERENCES `user` (`Nickname`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints der Tabelle `data_crimes_list`
--
ALTER TABLE `data_crimes_list`
  ADD CONSTRAINT `data_crimes_list_data_crimes_categories_ID_fk` FOREIGN KEY (`CategorieID`) REFERENCES `data_crimes_categories` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints der Tabelle `data_faq`
--
ALTER TABLE `data_faq`
  ADD CONSTRAINT `data_faq_ibfk_1` FOREIGN KEY (`katID`) REFERENCES `data_faq_category` (`ID`);

--
-- Constraints der Tabelle `faction_blacklist`
--
...
--
-- Constraints der Tabelle `faction_userrights`
--
...
--
-- Constraints der Tabelle `log_car_deletes`
--
ALTER TABLE `log_car_deletes`
  ADD CONSTRAINT `log_car_deletes_user_Nickname_fk` FOREIGN KEY (`Owner`) REFERENCES `user` (`Nickname`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints der Tabelle `log_casino`
--
...
--
-- Constraints der Tabelle `log_delstvo`
--
...
--
-- Constraints der Tabelle `log_gold`
--
ALTER TABLE `log_gold`
  ADD CONSTRAINT `log_gold_user_Nickname_fk` FOREIGN KEY (`Nickname`) REFERENCES `user` (`Nickname`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints der Tabelle `log_loosedriverlicense`
--
...
--
-- Constraints der Tabelle `log_playermoney`
--
...
--
-- Constraints der Tabelle `log_playtime`
--
ALTER TABLE `log_playtime`
  ADD CONSTRAINT `log_playtime_user_Nickname_fk` FOREIGN KEY (`Nickname`) REFERENCES `user` (`Nickname`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints der Tabelle `log_premium`
--
...
--
-- Constraints der Tabelle `log_steuern`
--
...
--
-- Constraints der Tabelle `objects_events_pickups`
--
...
--
-- Constraints der Tabelle `objects_houses`
--
ALTER TABLE `objects_houses`
  ADD CONSTRAINT `objects_houses_ibfk_1` FOREIGN KEY (`IRID`) REFERENCES `objects_houses_rooms` (`ID`);

--
-- Constraints der Tabelle `objects_houses_wishes`
--
ALTER TABLE `objects_houses_wishes`
  ADD CONSTRAINT `objects_houses_wishes_ibfk_1` FOREIGN KEY (`Nickname`) REFERENCES `user` (`Nickname`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints der Tabelle `objects_teleport_markers`
--
ALTER TABLE `objects_teleport_markers`
  ADD CONSTRAINT `objects_teleport_markers_objects_teleport_markers_ID_fk` FOREIGN KEY (`toMarker`) REFERENCES `objects_teleport_markers` (`ID`) ON DELETE SET NULL ON UPDATE SET NULL;
...
--
-- Constraints der Tabelle `user_crimes`
--
ALTER TABLE `user_crimes`
  ADD CONSTRAINT `user_crimes_user_Nickname_fk` FOREIGN KEY (`Nickname`) REFERENCES `user` (`Nickname`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `user_crimes_user_Nickname_fk_2` FOREIGN KEY (`ReporterUser`) REFERENCES `user` (`Nickname`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
-- Constraints der Tabelle `user_emails`
--
...
--
-- Constraints der Tabelle `user_gifts`
--
...
--
-- Constraints der Tabelle `user_gold`
--
ALTER TABLE `user_gold`
  ADD CONSTRAINT `user_gold_user_Nickname_fk` FOREIGN KEY (`Nickname`) REFERENCES `user` (`Nickname`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints der Tabelle `user_grades`
--
...
--
-- Constraints der Tabelle `user_jobskills`
--
...
--
-- Constraints der Tabelle `user_licenses`
--
...
--
-- Constraints der Tabelle `user_offline_data`
--
ALTER TABLE `user_offline_data`
  ADD CONSTRAINT `user_offline_data_user_Nickname_fk` FOREIGN KEY (`Nickname`) REFERENCES `user` (`Nickname`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints der Tabelle `user_offline_messages`
--
...
--
-- Constraints der Tabelle `user_tapps`
--
...
--
-- Constraints der Tabelle `user_tapps_friendlist`
--
...
--
-- Constraints der Tabelle `user_tapps_friendlist_request`
--
...
--
-- Constraints der Tabelle `user_tapps_tictactoe`
--
...
--
-- Constraints der Tabelle `user_tombupot`
--
...
--
-- Constraints der Tabelle `user_vehicles`
--
ALTER TABLE `user_vehicles`
  ADD CONSTRAINT `user_vehicles_user_Nickname_fk` FOREIGN KEY (`Besitzer`) REFERENCES `user` (`Nickname`) ON DELETE CASCADE ON UPDATE CASCADE;

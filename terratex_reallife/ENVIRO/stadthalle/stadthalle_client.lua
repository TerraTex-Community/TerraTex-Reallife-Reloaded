function createStadthallenGui()
    ...
    local credits = "Dieses Reallife Script basiert auf dem TerraTex Reloaded Reallife Script."
    credits = credits .. " TerraTex Reloaded Reallife Script von Colin Weber (terratex.eu) ist lizenziert unter einer Creative Commons Namensnennung-Nicht "
    credits = credits .. "kommerziell 4.0 International Lizenz."
    ...
    rows = guiGridListAddRow(Stadthalle_Grid[1])
    guiGridListSetItemText(Stadthalle_Grid[1], rows, 1, "Advanced Fishing License", false, false)
    guiGridListSetItemText(Stadthalle_Grid[1], rows, 2, "250000", false, true)

...
function deleteCrime_func(player, crimeId)
    CrimeSystem.deleteCrime(player, crimeId);
...
addEvent("deleteCrime", true);
addEventHandler("deleteCrime", getRootElement(), deleteCrime_func)

...
local munTruckMassage = { true, true, true, false, true, true, true, false, true, false, true, true, true }
        ...
        if (not (muntruckstarted)) then
            ...
            if (price > frakkasse[vioGetElementData(source, "fraktion")]) then
                ...
                for theKey, theValue in ipairs(munTruckMassage) do
                    if (theValue) then
                        local players = getPlayersInTeam(team[theKey])

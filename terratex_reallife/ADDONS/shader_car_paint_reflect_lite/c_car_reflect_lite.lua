...
function startCarPaintReflectLite()
    ...
    local v = Settings.var
    -- Create stuff
    grunShader = dxCreateShader("ADDONS/shader_car_paint_reflect_lite/fx/car_refgrun.fx", 1, v.renderDistance, true)
    geneShader = dxCreateShader("ADDONS/shader_car_paint_reflect_lite/fx/car_refgene.fx", 1, v.renderDistance, true)
    shatShader = dxCreateShader("ADDONS/shader_car_paint_reflect_lite/fx/car_refgene.fx", 1, v.renderDistance, true)
    ...
    if grunShader and geneShader and shatShader and myScreenSource then
        ...
        -- Set textures
        textureVol = dxCreateTexture("ADDONS/shader_car_paint_reflect_lite/images/smallnoise3d.dds")
        textureFringe = dxCreateTexture("ADDONS/shader_car_paint_reflect_lite/images/ColorRamp01.png")
...
function stopCarPaintReflectLite()
    ...
    if (isElement(textureFringe)) then

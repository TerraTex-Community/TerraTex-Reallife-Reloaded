...
function createBuyCars()
    ...
    --AUTOHAUS 2
    -- Motorradhändler
    vehicle = createVehicle(457, 526.5751953125, -1289.8154296875, 16.876752853394, 359.99450683594, 0, 324.28894042969)
    table.insert(autohausVehicles, { vehicle, "Caddy", 2, 2400.00 })
    vehicle = createVehicle(424, 531.908203125, -1289.658203125, 17.023422241211, 358.77502441406, 0, 325.88195800781)
    table.insert(autohausVehicles, { vehicle, "BF-Injection", 2, 64000.00 })
    vehicle = createVehicle(522, 539.794921875, -1291.28125, 16.807224273682, 358.87390136719, 0, 323.60778808594)
    table.insert(autohausVehicles, { vehicle, "NRG-500", 2, 210000.00 })
    vehicle = createVehicle(461, 537.2021484375, -1291.28515625, 16.822792053223, 358.80798339844, 0, 324.83825683594)
    table.insert(autohausVehicles, { vehicle, "PCJ-600", 2, 5800.00 })

    vehicle = createVehicle(521, 542.462890625, -1291.08203125, 16.809902191162, 359.21447753906, 0, 324.95361328125)
    table.insert(autohausVehicles, { vehicle, "FCR-900", 2, 3800.00 })
    vehicle = createVehicle(581, 545.087890625, -1291.0390625, 16.829500198364, 359.28039550781, 0, 325.56335449219)
    table.insert(autohausVehicles, { vehicle, "BF-400", 2, 3300.00 })
    vehicle = createVehicle(586, 547.94140625, -1290.6240234375, 16.76819229126, 359.90661621094, 0, 322.64099121094)
    table.insert(autohausVehicles, { vehicle, "Wayfarer", 2, 2400.00 })
    vehicle = createVehicle(463, 550.8095703125, -1290.8486328125, 16.781002044678, 359.9560546875, 359.99450683594, 325.83801269531)
    table.insert(autohausVehicles, { vehicle, "Freeway", 2, 21000.00 })
    vehicle = createVehicle(568, 564.56640625, -1290.96484375, 17.115060806274, 359.97253417969, 0, 354.74304199219)
    table.insert(autohausVehicles, { vehicle, "Bandito", 2, 40000.00 })
    vehicle = createVehicle(434, 561.158203125, -1291.224609375, 17.22172164917, 359.57153320313, 0, 354.86938476563)
    table.insert(autohausVehicles, { vehicle, "Hotknife", 2, 333000.00 })
    vehicle = createVehicle(468, 552.9384765625, -1291.083984375, 16.907585144043, 359.82971191406, 359.98901367188, 329.51843261719)
    table.insert(autohausVehicles, { vehicle, "Sanchez", 2, 7700.00 })
    vehicle = createVehicle(471, 558.5556640625, -1290.9619140625, 16.728891372681, 359.23645019531, 359.99450683594, 352.84790039063)
    table.insert(autohausVehicles, { vehicle, "Quadbike", 2, 25000.00 })
    vehicle = createVehicle(462, 535.033203125, -1291.1474609375, 16.802383422852, 359.1650390625, 0, 323.49243164063)

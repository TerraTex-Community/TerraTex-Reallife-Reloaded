...
fbi_tore={}
fbi_tore[1]=createObject(975, 2031.623046875, 2123.6000976563, 11.5050001144410, 0, 0, 1800)
setElementData(fbi_tore[1], "doubleside", true)
...
function open_fbi_tor_A(thePlayer)
	...
	if(isBeamter(thePlayer))then
		...
		if(getDistanceBetweenPoints3D ( px,py,pz,2031.623046875, 2123.6000976563, 11.5050001144410) < 10)then
			if not(fbi_torstatus[1])then
				moveObject(fbi_tore[1],2000,2023.9520263672,2123.6000976563, 11.5050001144410)
				fbi_torstatus[1]=true
			else
				moveObject(fbi_tore[1],2000,2031.623046875, 2123.6000976563, 11.5050001144410)
...
local SEKMARKER={
	{1972.8000488281,2186,24.700000762939,246.36999511719,87.660003662109,1003.6400146484,0},
	{246.36999511719,87.660003662109,1003.1400146484,1972.8000488281,2186,24.700000762939,6},
	...
	{2007.8000488281,2182.3999023438,10.800000190735,246.78999328613,62.639999389648,1003.6400146484,0},
	{246.78999328613,62.639999389648,1003.1400146484,2007.8000488281,2182.3999023438,10.800000190735,6}
}

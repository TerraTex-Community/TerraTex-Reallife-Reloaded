            ...
            if (elementtype == "player") then
                ...
                if (dis < 8) then
                    ...
                    if (clickedElement == getLocalPlayer()) then
                        ...
                        row = guiGridListAddRow(Click_Self_GUI_Grid[3])
                        guiGridListSetItemText(Click_Self_GUI_Grid[3], row, Click_Self_GUI_Column[5], "Erweiterter Angelschein", false, false)
                        guiGridListSetItemText(Click_Self_GUI_Grid[3], row, Click_Self_GUI_Column[6], changeJaNein_Interaktion(getElementData(getLocalPlayer(), "industrialFishingLic")), false, false)
                        row = guiGridListAddRow(Click_Self_GUI_Grid[3])

...
function eventTriggered ( source,killer,weapon,bodypart,suicide,usedVehicle )
	...
	outputKillMessage ( source, wr,wg,wb,killer,kr,kg,kb,weapon,bodypart)
	--
	local extra = ""
	if ( usedVehicle ) then
	extra = " (Vehicle)"
...
function outputKillMessage ( killed, wr,wg,wb,killer,kr,kg,kb,weapon,bodypart,width,resource )
	...
	return triggerClientEvent(getRootElement(),"onClientPlayerKillMessage",killed,killer,weapon,wr,wg,wb,kr,kg,kb,bodypart,width,resource )
end

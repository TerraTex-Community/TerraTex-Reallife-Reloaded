...
function enableDetail()
	...
	-- Load textures
	detail22Texture = dxCreateTexture('ADDONS/shaderdetails/media/detail22.png', "dxt3")
	detail58Texture = dxCreateTexture('ADDONS/shaderdetails/media/detail58.png', "dxt3")
	detail68Texture = dxCreateTexture('ADDONS/shaderdetails/media/detail68.png', "dxt1")
	detail63Texture = dxCreateTexture('ADDONS/shaderdetails/media/detail63.png', "dxt3")
	dirtyTexture = dxCreateTexture('ADDONS/shaderdetails/media/dirty.png', "dxt3")
	detail04Texture = dxCreateTexture('ADDONS/shaderdetails/media/detail04.png', "dxt3")
	detail29Texture = dxCreateTexture('ADDONS/shaderdetails/media/detail29.png', "dxt3")
	detail55Texture = dxCreateTexture('ADDONS/shaderdetails/media/detail55.png', "dxt3")
	detail35TTexture = dxCreateTexture('ADDONS/shaderdetails/media/detail35T.png', "dxt3")
...
function getMakeShader(v)
	...
	local shader,tec = dxCreateShader ( "ADDONS/shaderdetails/fx/detail.fx", 1, 100 )
	if shader then
